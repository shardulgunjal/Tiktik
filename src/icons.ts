/**
 * Tiktik - SVG Icons
 * Inline SVG icons for each toast type and UI controls.
 */
...
const icons: Record<string, string> = {
  ...
  loading: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="tiktik-spinner"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>`,
  ...
  default: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>`,
};

/**
 * Get the SVG icon HTML for a given toast type.
 */
