...
const toastOptionsFields = [
  { name: "message", type: "string", desc: "Toast text content" },
  {
    name: "type",
    type: "ToastType",
    desc: "Visual type: 'success' | 'error' | 'info' | 'warning'",
  },
  {
    name: "duration",
    type: "number",
    desc: "Auto-dismiss in ms. Infinity for persistent",
  },
...
const configFields = [
  {
    name: "type",
    type: "ToastType",
    desc: "Default toast type. Default: 'info'",
  },
  {
    name: "duration",
    type: "number",
    desc: "Default duration in ms. Default: 3000",
  },
  {
    name: "position",
    type: "ToastPosition",
    desc: "Default position. Default: 'top'",
  },
  {
    name: "progress",
    type: "boolean",
    desc: "Show progress bar by default. Default: false",
  },
  {
    name: "renderer",
    type: "CustomRenderer",
    desc: "Custom renderer — replaces default DOM template",
  },
  {
    name: "audio",
    type: "boolean",
    desc: "Enable audio cues (opt-in). Default: false",
  },
];
...
const cssVars = [
  ...
  {
    name: "--tiktik-radius-pill",
    default: "9999px",
    desc: "Border radius in compact (pill) state",
  },
  {
    name: "--tiktik-radius-card",
    default: "24px",
    desc: "Border radius in expanded (card) state",
  },
  {
    name: "--tiktik-shadow",
  ...
  },
  {
    name: "--tiktik-z-index",
    default: "999999",
    desc: "Z-index of the toast container",
  },
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {fields.map((f, i) => (
              <tr
                key={f.name}
                className={`border-b border-border ${i % 2 === 0 ? "bg-surface-raised" : "bg-surface"}`}
              >
  ...
  return (
    <div>
      ...
      <p className="text-text-secondary mb-8 leading-relaxed">
        Complete reference for all Tiktik methods, interfaces, and CSS custom
        properties.
      </p>
      ...
      <section className="mb-12">
        ...
        <p className="text-text-secondary text-sm mb-4">
          ...
          to customize the toast appearance.
        </p>
        <div className="rounded-xl border border-border overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
